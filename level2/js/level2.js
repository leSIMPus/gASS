document.addEventListener('DOMContentLoaded', () => {
  ...
  function canPlacePipe(r, c, type) {
    ...
    // Проверяем, что для каждого соседа, который имеет трубу и смотрит на текущую клетку, текущая труба имеет соответствующее направление
  ...
  function createImageFloatingText(cell, text, imageSrc, color, className = '') {
    if (!cell) return;
   ...
   `;
    ...
    boardEl.parentElement.appendChild(floatingContainer);
